...
function AdminBitacora() {
    ...
    return (
        <div className="container-fluid px-4 py-4 fade-in-up">
            ...
            <div className="card mb-4 p-3">
                <div className="row g-2 align-items-end">
                    <div className="col-md-2">
                        ...
                        <input type="text" className="form-control form-control-sm" placeholder="Ej: usuarios"
                            value={filters.nombre_dato} onChange={e => setFilters(f => ({ ...f, nombre_dato: e.target.value }))} />
                    </div>
                    <div className="col-md-2">
                        <label className="form-label small fw-medium">Movimiento</label>
                        <select className="form-select form-select-sm" value={filters.tipo_movimiento}
                    ...
                    <div className="col-md-2">
                        ...
                        <input type="text" className="form-control form-control-sm" placeholder="email o usuario BD"
                    ...
                    <div className="col-md-2">
                        ...
                        <input type="date" className="form-control form-control-sm" value={filters.fecha_desde}
                            onChange={e => setFilters(f => ({ ...f, fecha_desde: e.target.value }))} />
                    </div>
                    <div className="col-md-2">
                        <label className="form-label small fw-medium">Hasta</label>
                        <input type="date" className="form-control form-control-sm" value={filters.fecha_hasta}
            ...
            {/* Modal detalle */}
            {detail && (
                <div className="modal d-block" style={{ background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(4px)' }} onClick={() => setDetail(null)}>
